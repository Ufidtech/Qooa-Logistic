...
const vendorSchema = new mongoose.Schema(
  {
    ...
    whatsappNumber: {
      type: String,
      trim: true,
      sparse: true, // optional, allow multiple nulls
    },
    email: {
      type: String,
      trim: true,
...
vendorSchema.index({ whatsappNumber: 1 });
// For backward-compatibility, also index common variants (without +)
vendorSchema.index({ phoneNumberNormalized: 1 });
